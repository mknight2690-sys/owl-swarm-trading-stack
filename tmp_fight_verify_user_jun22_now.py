...
def trend_bias(candles):
    ...
    return {"bias": bias, "rsi": rsi(closes), "mom5": mom, "last": last}
...
if not funding_favorable_short:
    notes_parts.append(
        f"ERROR: funding {fr:.6f} positive (shorts pay); not favorable for short"
    )
else:
...
notes_parts.append("FIGHT-USDT on avoid list; recent closed short pnl=-0.00884")
