...
checks = {
    ...
    "15m_momentum_bullish": ta15["bias"] == "long" or (ta15["mom_pct"] > 0 and (ta15["rsi"] or 50) > 50),
...
if not checks["15m_momentum_bullish"]:
    notes.append(f"15m weak RSI {ta15['rsi']} mom {ta15['mom_pct']:+.2f}% bias {ta15['bias']}")
...
notes.append("DRIFT track record 1W/0L +0.33 PnL")
if liq_dist < 5:
