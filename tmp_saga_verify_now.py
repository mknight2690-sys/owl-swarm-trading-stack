...
if abs(price - 0.0155) / 0.0155 > 0.01:
    issues.append(f"claimed price 0.0155 vs live {price:.5f}")
if abs(change24h - 10.399) > 1.0:
    issues.append(f"claimed 24h change 10.399% vs live {change24h:.2f}%")
if abs(vol - 9757721) / 9757721 > 0.05:
    issues.append(f"claimed volume 9757721 vs live {vol:.0f}")
