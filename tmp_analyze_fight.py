...
pivot = round((support + resistance + cl1h[-1]) / 3, 6)
price = round(cl1m[-1], 6)
...
# short_score 0.856 vs long 0.406 - bias short
if avg_mom < 0.45 and not avoid_short:
    suggested = "short"
...
summary = (
    ...
    f"24h -10.7% downtrend; spread {spread:.3f}%; funding {fund_rate:.6f}"
)
