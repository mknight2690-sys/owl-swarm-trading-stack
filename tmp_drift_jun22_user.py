...
if aligned_long:
    ...
    trend = "bearish"
elif ta1h["bias"] == "long" and ta15["bias"] in ("long", "neutral"):
    trend = "bullish_mixed"
elif ta1h["bias"] == "short" and ta15["bias"] in ("short", "neutral"):
    trend = "bearish_mixed"
else:
    trend = "mixed"
...
if aligned_long or aligned_short:
    ...
    conf -= 0.1
conf += 0.03  # positive DRIFT track record
...
suggested = None
if conf >= 0.5 and spread_ok and favorable_long and (
    aligned_long or (ta15["bias"] == "long" and ta1h["bias"] == "long")
):
    suggested = "long"
elif conf >= 0.5 and spread_ok and favorable_short and (
    aligned_short or (ta15["bias"] == "short" and ta1h["bias"] == "short")
):
    suggested = "short"

if suggested is None or conf < 0.5:
    suggested = "neutral"
    if conf >= 0.5:
        conf = 0.45
