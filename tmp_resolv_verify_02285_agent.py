...
if abs(price - 0.02285) / 0.02285 > 0.01:
    note_bits.append(f"user price 0.02285 differs from live {price:.5f}")
if abs(change24h - 27.44) > 1:
    note_bits.append(f"user 24h change 27.44% differs from live {change24h:.2f}%")
if issues:
