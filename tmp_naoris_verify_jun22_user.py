...
if fr > 0:
    issues.append(f"funding rate {fr:.6f} positive longs pay shorts not favorable for long")
elif not favorable_long:
...
note_bits = [
    ...
    f"live price {price:.5f} vs stated 0.03682 24h {change24h:.2f}% vol {vol:.0f}",
