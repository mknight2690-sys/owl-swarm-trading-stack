...
resist = round(max(ta1["high"], ta15["high"], ta1h["high"]), 5)
key_levels = sorted(set([support, round(price * 0.99, 5), round(price, 5), round(price * 1.01, 5), resist]))
...
if conf >= 0.5 and spread_ok and favorable_long and aligned_long:
    ...
    suggested = "short"
elif conf >= 0.5 and spread_ok and favorable_long and long_c >= 2:
    suggested = "long"
elif conf >= 0.5 and spread_ok and favorable_short and short_c >= 2:
    suggested = "short"
else:
    suggested = None
