...
if spread_ok:
    if aligned_long and favorable_long:
        ...
        if ta15["tech"] >= 0.55 and favorable_long and ta15["bias"] != "short":
            suggested = "long"
        elif ta15["tech"] <= 0.45 and favorable_short and ta15["bias"] != "long":
            suggested = "short"
        elif change24h > 5 and favorable_long and ta1h["bias"] != "short":
            suggested = "long"
        elif change24h < -5 and favorable_short and ta1h["bias"] != "long":
            suggested = "short"
