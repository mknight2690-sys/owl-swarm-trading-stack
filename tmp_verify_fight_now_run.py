...
if t1["chg"] > 0:
    notes_parts.append(f"ERROR: 1m period +{t1['chg']:.2f}% contradicts short momentum claim")
if t15["bias"] == "long":
    notes_parts.append("ERROR: 15m EMA bias is long not short; bearish alignment claim unverified")
