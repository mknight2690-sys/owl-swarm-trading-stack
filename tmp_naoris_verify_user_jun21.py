...
if abs(price - 0.04133) / 0.04133 > 0.01:
    issues.append(f"claimed price 0.04133 vs live {price:.5f}")
if abs(change24h - 35.154) > 1.0:
    issues.append(f"claimed 24h change 35.154% vs live {change24h:.2f}%")
if abs(vol - 4623490) / 4623490 > 0.05:
    issues.append(f"claimed volume 4623490 vs live {vol:.0f}")
