...
def bridge(method, args):
    args_file = ROOT / "tmp_ub_live_args.json"
...
ticker = first(bridge("get_ticker", {"inst_id": INST}))
ob = bridge("get_order_book", {"inst_id": INST})
fund = first(bridge("get_funding_rate", {"inst_id": INST}))
...
if change24h > 50 and r1 and r1 > 70:
    confidence -= 0.1
if change24h > 50 and r15 and r15 > 70:
    confidence -= 0.05
...
summary = (
    ...
    f"24h +{change24h:.1f}% pump; spread {spread:.2f}%; funding {fund_rate:.6f}"
)
