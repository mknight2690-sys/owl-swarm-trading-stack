...
if abs(price - 0.02297) / 0.02297 > 0.01:
    note_bits.append(f"user price 0.02297 differs from live {price:.5f}")
if abs(change24h - 29.19) > 1:
    note_bits.append(f"user 24h change 29.19% differs from live {change24h:.2f}%")
if issues:
