...
ticker = fetch("get_ticker", {"inst_id": "SAGA-USDT"})
...
c1m = parse_candles(fetch("get_candles", {"inst_id": "SAGA-USDT", "bar": "1m", "limit": "50"}))
c15 = parse_candles(fetch("get_candles", {"inst_id": "SAGA-USDT", "bar": "15m", "limit": "30"}))
c1h = parse_candles(fetch("get_candles", {"inst_id": "SAGA-USDT", "bar": "1H", "limit": "24"}))
