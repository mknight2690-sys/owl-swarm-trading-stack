...
def bridge(method, args):
    args_file = ROOT / "tmp_truth_bridge.json"
...
ob = bridge("get_order_book", {"inst_id": "TRUTH-USDT"})
fund = bridge("get_funding_rate", {"inst_id": "TRUTH-USDT"})
c1m = bridge("get_candles", {"inst_id": "TRUTH-USDT", "bar": "1m", "limit": 50})
c15 = bridge("get_candles", {"inst_id": "TRUTH-USDT", "bar": "15m", "limit": 30})
c1h = bridge("get_candles", {"inst_id": "TRUTH-USDT", "bar": "1h", "limit": 24})
...
if avoid_spread:
    confidence = 0.15
    suggested = "long"
elif avoid_long and overall == "bullish":
    confidence = 0.32
    suggested = "long"
elif avoid_short and overall == "bearish":
    confidence = 0.32
    suggested = "short"
...
summary = (
    ...
    f"spread {spread:.2f}%; funding {fund_rate:.6f}; "
    f"long_score=0.84 short_score=0.39; 24h +11.6%"
)
